...
namespace BackendBooking.Service
{
    public class ReservationService : IReservationService
    {
        ...
        public ReservationService(BookingDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }

        #region CreateReservaionAsync
        public async Task<int> CreateReservationAsync(CreateReservationModel model)
        {
            try
            {
